...
from utils.Functions import show_imgs
...
class Data_Loader_ImgNet:
    ...
    def __init__(self, train_batch_size, test_batch_size, train_shuffle=True):
        ...
        train_data_set = datasets.ImageFolder(
            root="C:\\Users\\26592\\Desktop\\Imagenet2012\\train",
            transform=train_transform,
        )

        test_data_set = datasets.ImageFolder(
            root="C:\\Users\\26592\\Desktop\\Imagenet2012\\val",
...
if __name__ == "__main__":
    ...
    data_loader = Data_Loader_ImgNet(train_batch_size=25, test_batch_size=25, train_shuffle=False)

    for i, (x, y) in enumerate(data_loader.train_data_loader):
